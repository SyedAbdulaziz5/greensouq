...
async function IndoorPlantsSection() {
  try {
    const products = await fetchProducts("Indoor Plants");
    ...
    console.error("Error loading indoor plants:", error);
    return (
      <section>
        <h2 className="text-2xl text-gray-800 mb-6 text-center mt-14">
          Top Selling Indoor Plants
        </h2>
...
export default IndoorPlantsSection;
